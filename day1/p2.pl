parseNumsHelper([], Acc, Acc).

parseNumsHelper([o, n, e | T], Acc, Output) :- parseNumsHelper([n, e | T], ["1" | Acc], Output).
parseNumsHelper([t, w, o | T], Acc, Output) :- parseNumsHelper([w, o | T], ["2" | Acc], Output).
parseNumsHelper([t, h, r, e, e | T], Acc, Output) :- parseNumsHelper([h, r, e, e | T], ["3" | Acc], Output).
parseNumsHelper([f, o, u, r | T], Acc, Output) :- parseNumsHelper([o, u, r | T], ["4" | Acc], Output).
parseNumsHelper([f, i, v, e | T], Acc, Output) :- parseNumsHelper([i, v, e | T], ["5" | Acc], Output).
parseNumsHelper([s, i, x | T], Acc, Output) :- parseNumsHelper([i, x | T], ["6" | Acc], Output).
parseNumsHelper([s, e, v, e, n | T], Acc, Output) :- parseNumsHelper([e, v, e, n | T], ["7" | Acc], Output).
parseNumsHelper([e, i, g, h, t | T], Acc, Output) :- parseNumsHelper([i, g, h , t | T], ["8" | Acc], Output).
parseNumsHelper([n, i, n, e | T], Acc, Output) :- parseNumsHelper([i, n, e | T], ["9" | Acc], Output).
parseNumsHelper([H | T], Acc, Output) :- char_type(H, digit), parseNumsHelper(T, [H | Acc], Output).
parseNumsHelper([_ | T], Acc, Output) :- parseNumsHelper(T, Acc, Output).

parseNums(Y, R) :- parseNumsHelper(Y, [], Temp), reverse(Temp, R).
